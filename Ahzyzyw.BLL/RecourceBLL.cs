...
{
    public class RecourceBLL : IResourceBLL
    {
        ...
        {
            return _resourceDAL.GetResource(resID);
        }
        ...
        {
            return _resourceDAL.EditResource(resource);
        }
        ...
        public bool UpdateResourceImage(Guid resID, byte[] imageBytes, string ext)
        {

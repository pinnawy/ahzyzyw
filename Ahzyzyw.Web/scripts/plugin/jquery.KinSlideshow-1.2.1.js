...
$.fn.KinSlideshow = function(settings){
	  ...
	  settings = jQuery.extend({
		   ...
		   moveStyle:"down",//切换方向 可选值：【 left | right | up | down 】left:向左切换,right:向右切换,up:向上切换,down:向下切换 [默认向左切换]
		   ...
		   titleBar:{titleBar_height:32,titleBar_bgColor:"#000000",titleBar_alpha:0.5},//标题背景样式，(isHasTitleBar = true 前提下启用)
		   ...
		   btn:{btn_bgColor:"#2d2d2d",btn_bgHoverColor:"#1072aa",btn_fontColor:"#FFFFFF",btn_fontHoverColor:"#FFFFFF",btn_fontFamily:"Verdana",btn_borderColor:"#4a4a4a",btn_borderHoverColor:"#1188c0",btn_borderWidth:1,btn_bgAlpha:0.7}//按钮样式设置，(isHasBtn = true 前提下启用)
	  },settings);
	 ...
	 function KSS_setBtn(){
		 ...
		 if(settings.isHasBtn && KSS_imgaeLength >= 2){
			 $(ksthis).append("<div class='KSS_btnBox' style='position:absolute;right:15px;bottom:5px;z-index:200'></div>");
			 var KSS_btnList = "";

...
namespace ecl.Common.Comm
{
    ...
    public class JScript
    {
        ...
        /// <summary>
        /// 弹出JavaScrtipt 提示信息，再返回上一页
        /// 处理流程:
        /// 算法描述:
        /// 日 期: 2007-10-16 19:15
        /// </summary>
...
<script language=Javascript>
      function KendoPostBack(eventTarget, eventArgument) 
      {
        ...
        public static void Alert(string title, string message, System.Web.UI.Page page)
        {
            message = StringUtil.DeleteUnVisibleChar(message);
            string js = @"<Script language='JavaScript'>
                    msg('" + title + "',1,'350','" + message + "','');</Script>";

            //page.RegisterStartupScript("CustomerAlert", js);
            page.ClientScript.RegisterClientScriptBlock(page.GetType(),"CustomerAlert", js);
        }
        /// <summary>
        /// 弹出自定义的对话框并且返回前一页
        /// </summary>
        ...
        public static void AlertAndGoback(string title, string message, System.Web.UI.Page page)
        {
            message = StringUtil.DeleteUnVisibleChar(message);
            string js = @"<Script language='JavaScript'>
                    msg('" + title + "',4,'350','" + message + "','');</Script>";
           // page.RegisterStartupScript("CustomerAlertAndGoback", js);
            page.ClientScript.RegisterStartupScript(page.GetType(),"CustomerAlertAndGoback", js);
        }
